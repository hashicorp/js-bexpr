...
function peg$parse(input, options) {
  ...
  function peg$parseExpression() {
    ...
    if (s0 === peg$FAILED) {
      ...
      if (s0 === peg$FAILED) {
        s0 = peg$parseParentheticalExpression();
      }
    }
  ...
  function peg$parseParentheticalExpression() {
  ...
  function peg$parseAndExpression() {
    ...
    if (s1 === peg$FAILED) {
      s1 = peg$parseParentheticalExpression();
    }
    if (s1 !== peg$FAILED) {
      s2 = peg$parse_();
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseMatchExpression() {
    ...
    s0 = peg$parseEqualsExpression();
    if (s0 === peg$FAILED) {
      s0 = peg$parseNotEqualsExpression();
      if (s0 === peg$FAILED) {
  ...
  function peg$parseNotEqualsExpression() {
    var s0, s1, s2, s3, s4, s5;
